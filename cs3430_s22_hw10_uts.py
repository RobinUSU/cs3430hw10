...
class cs3430_s22_hw10_uts(unittest.TestCase):
    ...
    #     # a, b, m, n, seed = 214013, 2531011, 4294967296, 10000000, 11235 # Orig
    #     a, b, m, n, seed = 214013, 2531011, 4294967296, 100, 11235 # Faster test call
    #
    #     lcgg = prng.lcg(a, b, m, n, x0=seed)()
    #     rns = [next(lcgg) for _ in range(n)]
    ...
    #     # a, b, m, n, seed = 438293613, (2**13 + 13), 2**30, 20000000, 58132134 # Orig
    #     a, b, m, n, seed = 438293613, (2**13 + 13), 2**30, 200, 58132134 # Faster test call
    #
    #     lcgg = prng.lcg(a, b, m, n, x0=seed)()
    #     rns = [next(lcgg) for _ in range(n)]
    ...
    #     # a, b, m, n, seed = 12132445, (2**17 + 17), 2**36, 30000000, 11235813 # Orig
    #     a, b, m, n, seed = 12132445, (2**17 + 17), 2**36, 300, 11235813 # Faster test
    #
    #     lcgg = prng.lcg(a, b, m, n, x0=seed)()
    #     rns = [next(lcgg) for _ in range(n)]
    ...
    #     a, b, m, n, seed = 181465474592829, (2 ** 19 + 19), 2 ** 48, 400, 3581311224 # Faster debug Call
    #
    #     lcgg = prng.lcg(a, b, m, n, x0=seed)()
    #     rns = [next(lcgg) for _ in range(n)]
    ...
    #     #a, b, m, n, seed = 454339144066433781, (2**23 + 23), 2**60, 50000000, 3582241311 # Original
    #     a, b, m, n, seed = 454339144066433781, (2 ** 23 + 23), 2 ** 60, 500, 3582241311 # Faster test call
    #
    #     lcgg = prng.lcg(a, b, m, n, x0=seed)()
    #     rns = [next(lcgg) for _ in range(n)]
    ...
    #     # a, b, c, n, seed = 1, 3, 10, 1000000, 7 # Original
    #     a, b, c, n, seed = 1, 3, 10, 100, 7 # Faster test call
    #
    #     xsg = prng.xorshift(a, b, c, n, x0=seed)()
    #     rns = [next(xsg) for _ in range(n)]
    #     ### print('XORSHIFT random numbers: {}'.format(rns))
    ...
    #     # a, b, c, n, seed = 2, 5, 15, 1000000, 13 # Orig
    #     a, b, c, n, seed = 2, 5, 15, 100, 13 # Faster debug call
    #
    #     xsg = prng.xorshift(a, b, c, n, x0=seed)()
    #     rns = [next(xsg) for _ in range(n)]
    #     ### print('XORSHIFT random numbers: {}'.format(rns))
    ...
    #     # a, b, c, n, seed = 3, 23, 25, 2000000, 17 # Original
    #     a, b, c, n, seed = 3, 23, 25, 200, 17 # Fast Test
    #
    #     xsg = prng.xorshift(a, b, c, n, x0=seed)()
    #     rns = [next(xsg) for _ in range(n)]
    #     ### print('XORSHIFT random numbers: {}'.format(rns))
    ...
    #     #a, b, c, n, seed = 5, 9, 28, 20000000, 19 # Orig
    #     a, b, c, n, seed = 5, 9, 28, 200, 19 # Fasttest
    #
    #     xsg = prng.xorshift(a, b, c, n, x0=seed)()
    #     rns = [next(xsg) for _ in range(n)]
    #     ### print('XORSHIFT random numbers: {}'.format(rns))
    ...
    #     # a, b, c, n, seed = 7, 13, 25, 30000000, 23 # Original
    #     a, b, c, n, seed = 7, 13, 25, 300, 23 # Fasttest
    #
    #     xsg = prng.xorshift(a, b, c, n, x0=seed)()
    #     rns = [next(xsg) for _ in range(n)]
    #     ### print('XORSHIFT random numbers: {}'.format(rns))
    ...
    #     #a, b, c, n, seed = 13, 3, 27, 50000000, 113 # Orig
    #     a, b, c, n, seed = 13, 3, 27, 500, 113 # Fast
    #
    #     xsg = prng.xorshift(a, b, c, n, x0=seed)()
    #     rns = [next(xsg) for _ in range(n)]
    #     ### print('XORSHIFT random numbers: {}'.format(rns))
    ...
    #     # a, b, c, n, seed = 13, 3, 27, 50000000, 117 # Orig
    #     a, b, c, n, seed = 13, 3, 27, 500, 117 # Fasttest
    #
    #     xsg = prng.xorshift(a, b, c, n, x0=seed)()
    #     rns = [next(xsg) for _ in range(n)]
    #     ### print('XORSHIFT random numbers: {}'.format(rns))
